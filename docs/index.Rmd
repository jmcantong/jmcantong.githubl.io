...
```{r pressure, echo=FALSE, fig.cap="Shapfile of the City of Los Angeles. Excludes tracts with a population > 500, as well as anomaly tracts that would create outliers in results (LAX, Griffith Park, Dodger Stadium, UCLA, etc.)"}
